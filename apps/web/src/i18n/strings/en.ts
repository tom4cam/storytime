export const en = {
  ...
  'create.readAloud': 'Read aloud',
  'create.readAloudOn': 'Read aloud is on — tap anything to hear it',
  'create.readAloudOff': 'Read aloud is off — tap the speaker to turn it on',
  ...
  'edit.regenerateText': 'Rewrite this text when I save',
  'edit.changeLabel': 'What to change (optional)',
  'edit.changePlaceholder': 'e.g. give her curly red hair, or make him braver',
  'edit.cancel': 'Cancel',
